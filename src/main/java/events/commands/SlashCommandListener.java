        ...
        public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
            if (Objects.equals(event.getSubcommandName(), "search")) {
                ...
                if (name == null && type == null && atk == null && def == null && level == null && race == null && attribute == null && link == null && linkMarker == null && scale == null && cardSet == null && archetype == null) {
                            eb.addField("Usage","To use this bot, type '/card search' and select at least one of the options, " +
                ...
                try {
                    ...
                    if(result.isEmpty()){
                        eb.addField("Error","No cards found. Please check if your input is correct" +
                    ...
                    if (result.size() > 100){
                        eb.addField("Error","Too many cards found, 100+" + "\n"+
                    ...
                    try {
                        ...
                        String imageUrl = result.get(0).getCardImages().get(0).getImageUrl();
                        ...
                        eb.setTitle(result.get(0).getName());
                        eb.setImage("attachment://card.jpg");
                        //If,else if logic depending on the card type.
                        if (result.get(0).getFrameType().equals("spell")){
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Type of spell card: " + result.get(0).getRace() + "\n" +
                                            "Effect: " + "\n"  + result.get(0).getDesc() + "\n" +"\n" +
                                            "Cheapest version on cardmarket: " +"\u20ac"+ result.get(0).getCardPrices().get(0).getCardmarketPrice()
                                    ,true);
                            Color spellColor = new Color(22,128,120,255);
                            eb.setColor(spellColor);
                        }
                        else if(result.get(0).getFrameType().equals("trap")){
                            if (result.get(0).getRace() == null){
                                result.get(0).setRace("normal");
                            }
                            eb.addField("Card information",
                                            result.get(0).getType() + "\n" +
                                            "Type of trap card: " + result.get(0).getRace() + "\n" +
                                                    "Effect: " + "\n"  + result.get(0).getDesc() + "\n" +"\n" +
                                                    "Cheapest version on cardmarket: " +"\u20ac"+ result.get(0).getCardPrices().get(0).getCardmarketPrice()
                                    ,true);
                        ...
                        else if(result.get(0).getFrameType().equals("effect")){
                        eb.addField("Card information",
                                result.get(0).getType() + "\n" +
                                "Level: " + result.get(0).getLevel().toString() + "\n" +
                                        "Attribute: " + result.get(0).getAttribute() + "\n" +
                                        "Type: " + result.get(0).getRace() + "\n" +
                                        "Effect: " + "\n"  + result.get(0).getDesc() + "\n" +
                                        "Attack: " + result.get(0).getAtk() + "\n" +
                                        "Defence: " + result.get(0).getDef() + "\n"+"\n" +
                                        "Cheapest version on cardmarket: " +"\u20ac"+ result.get(0).getCardPrices().get(0).getCardmarketPrice()
                                ,true);
                            Color effectColor = new Color(185,134,115,255);
                            eb.setColor(effectColor);
                    }
                        else if(result.get(0).getFrameType().equals("ritual")){
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Level: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("normal")){
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Level: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("xyz")){
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Rank: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                                            "Type: " + result.get(0).getRace() + "\n" +
                                            "Effect: " + "\n"  + result.get(0).getDesc() + "\n" +
                                            "Attack: " + result.get(0).getAtk() + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("normal_pendulum") || result.get(0).getFrameType().equals("effect_pendulum") || result.get(0).getFrameType().equals("ritual_pendulum") ||result.get(0).getFrameType().equals("fusion_pendulum")||result.get(0).getFrameType().equals("synchro_pendulum") ){
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Level: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                                            "Type: " + result.get(0).getRace() + "\n" +
                                            "Scale: " + result.get(0).getScale() + "\n" +
                                            "Effect: " + "\n" + result.get(0).getMonsterDesc() + "\n" +
                                            "Pendulum effect: " + "\n" + result.get(0).getPendDesc() + "\n" +
                                            "Attack: " + result.get(0).getAtk() + "\n" +
                                            "Defence: " + result.get(0).getDef() + "\n"+"\n" +
                                            "Cheapest version on cardmarket: " +"\u20ac"+ result.get(0).getCardPrices().get(0).getCardmarketPrice()
                                    ,true);
                        ...
                        }else if(result.get(0).getFrameType().equals("fusion")){
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Level: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("synchro")) {
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Level: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("link")) {
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Link: " + result.get(0).getLinkval().toString() + "\n" +
                                            "Link: " + result.get(0).getLinkmarkers().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                                            "Type: " + result.get(0).getRace() + "\n" +
                                            "Effect: " + "\n" + result.get(0).getDesc() + "\n" +
                                            "Attack: " + result.get(0).getAtk() + "\n" + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("xyz_pendulum")) {
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "Rank: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                        ...
                        else if(result.get(0).getFrameType().equals("token")) {
                            eb.addField("Card information",
                                    result.get(0).getType() + "\n" +
                                            "level: " + result.get(0).getLevel().toString() + "\n" +
                                            "Attribute: " + result.get(0).getAttribute() + "\n" +
                            ...
                            event.getHook().sendMessageEmbeds(eb.build()).addFiles(FileUpload.fromData(imageFile, "card.jpg")).queue();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
